...
namespace OroCRM\Bundle\ZendeskBundle\Tests\Functional\ImportExport\Job;
...
class AbstractImportExportJobTestCase extends WebTestCase
{
    ...
    /**
     * @var ZendeskRestTransport|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $resource;
    ...
    {
        $this->getContainer()->set('orocrm_zendesk.transport.rest_transport', $this->realResource);
        unset(
    ...
    {
        $this->resource = $this->getMockBuilder(ZendeskRestTransport::class)
        ...
        $this->realResource = $this->getContainer()
            ->get('orocrm_zendesk.transport.rest_transport');

        $this->getContainer()
            ->set('orocrm_zendesk.transport.rest_transport', $this->resource);
    }
}
